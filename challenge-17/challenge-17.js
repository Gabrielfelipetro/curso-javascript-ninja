...
*/
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/g, "Gabriel Felipe Almeida Trovato")
  );
...
*/
  ...
  console.log(text.replace(/brasileiro/g, "sul matogrossense"));
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/, function (upper) {
